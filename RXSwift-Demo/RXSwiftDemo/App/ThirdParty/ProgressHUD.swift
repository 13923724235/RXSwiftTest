...
class ProgressHUD: UIView {
    ...
    fileprivate func bindActivityImageView() {
        ...
        addConstraint(NSLayoutConstraint(item: activityImageView, attribute: NSLayoutConstraint.Attribute.centerX, relatedBy: NSLayoutConstraint.Relation.equal, toItem: self, attribute: NSLayoutConstraint.Attribute.centerX, multiplier: 1.0, constant: 0.0))
        addConstraint(NSLayoutConstraint(item: activityImageView, attribute: NSLayoutConstraint.Attribute.centerY, relatedBy: NSLayoutConstraint.Relation.equal, toItem: self, attribute: NSLayoutConstraint.Attribute.centerY, multiplier: 1.0, constant: 0.0))
    ...
    fileprivate func startActivity() {
        bringSubviewToFront(activityImageView)
